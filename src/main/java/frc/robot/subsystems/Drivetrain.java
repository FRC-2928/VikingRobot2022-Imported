...
public class Drivetrain extends SubsystemBase {
    ...
    public Drivetrain(Supplier<Transmission.GearState> gearStateSupplier) {
        ...
        Pose2d initialPose = new Pose2d(0, 1.5, m_pigeon.getRotation2d()); 
        m_odometry = new DifferentialDriveOdometry(initialHeading,  getLeftDistanceMeters(), getRightDistanceMeters(), 
        initialPose);
