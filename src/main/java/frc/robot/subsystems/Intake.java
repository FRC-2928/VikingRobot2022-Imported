...
public class Intake extends SubsystemBase {
  ...
  // GenericEntry m_intakeBrakeEnabledEntry;
  GenericEntry m_feederBrakeEnabledEntry;
  GenericEntry m_intakeBrakeActivatedEntry;
  GenericEntry m_feederMotorOnEntry, m_intakeMotorOnEntry;
  GenericEntry m_intakeHasBallEntry, m_feederHasBallEntry;
  GenericEntry m_intakeMotorEntry, m_feederMotorEntry;
  GenericEntry m_rampEntry; 
  GenericEntry m_allianceEntry, m_ballColorEntry, m_ballValidEntry;
  GenericEntry m_intakeMotorSpeedEntry;
  ...
  public void publishTelemetry() {
    ...
    m_intakeMotorEntry.setDouble(m_intakeMotor.getMotorOutputPercent());
    m_feederMotorOnEntry.setBoolean(isFeederMotorOn());
    m_feederMotorEntry.setDouble(m_rightFeederMotor.getMotorOutputPercent());
