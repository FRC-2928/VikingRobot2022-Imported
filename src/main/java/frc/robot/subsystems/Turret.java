...
public class Turret extends SubsystemBase {
  ...
  private GenericEntry m_targetHOEntry;
  private GenericEntry m_headingOffsetEntry, m_turretPowerEntry;
  private GenericEntry m_turretOffsetEntry, m_targetOffsetEntry;
  private GenericEntry m_targetLockedEntry, m_targetFoundEntry, m_estimatedTargetRotationEntry;
  ...
  public void publishTelemetry() {   
    m_targetHOEntry.setDouble(getTargetHorizontalOffset());
    m_turretPowerEntry.setDouble(m_turretMotor.getMotorOutputPercent());
    m_turretOffsetEntry.setDouble(getTurretToRobotOffset().getDegrees());   
    m_headingOffsetEntry.setDouble(getTurretToHeadingOffset().getDegrees());
    m_targetOffsetEntry.setDouble(getTargetToHeadingOffset().getDegrees());
    m_estimatedTargetRotationEntry.setDouble(getEstimatedTargetRotation().getDegrees());
